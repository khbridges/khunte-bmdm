...
paths = ['/Users/katebridges/Downloads/GSE161125_RAW/M0_H/',
         '/Users/katebridges/Downloads/GSE161125_RAW/M1_H/',
         '/Users/katebridges/Downloads/GSE161125_RAW/M2_H/',
         '/Users/katebridges/Downloads/GSE161125_RAW/M1-2_H/']
...
filt_param['M1+M2'] = {'min_counts': 6000,
                       'max_counts': 70000,
                       'min_genes': 1600,
                       'max_genes': 6200}
...
for path1, sample in zip(paths, samples):
    ...
    data_genes = pd.read_csv(path1 + 'features.tsv', header=None, sep='\t')
